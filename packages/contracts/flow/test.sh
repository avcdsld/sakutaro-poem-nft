...
# Mint NFT
flow transactions send ./transactions/mint_nft.cdc --signer emulator-account2
...
flow scripts execute ./scripts/get_nft_metadata_detail.cdc 0x179b6b1cb6755e31 1
flow scripts execute ./scripts/get_nft_metadata_svg.cdc 0x179b6b1cb6755e31 1

# Mint Replica NFT
flow transactions send ./transactions/setup_account_replica.cdc --signer emulator-account2
flow transactions send ./transactions/mint_nft_replica.cdc --signer emulator-account2
flow scripts execute ./scripts/get_nft_metadata_detail_replica.cdc 0x01cf0e2f2f715450 1

# Transfer NFT and Check if poemID is changed
flow transactions send ./transactions/transfer_nft.cdc 0x01cf0e2f2f715450 1 --signer emulator-account3
flow scripts execute ./scripts/get_nft_metadata_detail.cdc 0x01cf0e2f2f715450 1
